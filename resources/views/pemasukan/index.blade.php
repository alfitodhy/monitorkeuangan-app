...
@section('content')
    <div class="container mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div class="mb-4 flex flex-col md:flex-row md:justify-between md:items-center gap-2">
            <input type="text" id="pemasukanSearch" placeholder="Cari proyek..."
            ...
            <table id="pemasukanTable" class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-xs">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-3 py-2 text-right font-semibold text-gray-600 dark:text-gray-300 uppercase">Nilai
                            Proyek</th>
                        <th class="px-3 py-2 text-right font-semibold text-gray-600 dark:text-gray-300 uppercase">Nilai
                            Proyek Addendum</th>
                        <th class="px-3 py-2 text-right font-semibold text-gray-600 dark:text-gray-300 uppercase">Total
                            Termin</th>
                        <th class="px-3 py-2 text-right font-semibold text-gray-600 dark:text-gray-300 uppercase">Termin
                            Addendum</th>
                        <th class="px-3 py-2 text-right font-semibold text-gray-600 dark:text-gray-300 uppercase">Total
                            Dibayar</th>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            const table = $('#pemasukanTable').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'nilai_proyek_addendum',
                        name: 'nilai_proyek_addendum',
                    ...
                    {
                        data: 'termin_addendum',
                        name: 'termin_addendum',
                        className: 'text-right text-indigo-600',
                        render: $.fn.dataTable.render.number('.', ',', 0)
                    },
                    {
                ...
                drawCallback: function(settings) {
                    ...
                    $('#pemasukanInfo').html(
                        `Menampilkan ${info.start+1} sampai ${info.end} dari ${info.recordsTotal} proyek`
                        );
