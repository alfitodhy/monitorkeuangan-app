                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-xs">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-3 py-2 text-center font-semibold text-gray-600 dark:text-gray-300 uppercase">
                                    No</th>
                                <th class="px-3 py-2 text-left font-semibold text-gray-600 dark:text-gray-300 uppercase">
                                    Proyek</th>
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach ($pemasukan as $index => $item)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-75">
                                    <td class="px-3 py-2 text-center text-gray-700 dark:text-gray-200 font-medium">
                                        {{ $index + 1 }}</td>
