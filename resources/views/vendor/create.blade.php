...
<div class="container mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div>
                    ...
                    <datalist id="spesialisasi_options">
                        {{-- Loop untuk menampilkan data yang sudah ada dari database --}}
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="3"
                        class="w-full border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm dark:bg-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">{{ old('alamat') }}</textarea>
                </div>
            </div>
    ...
    <div id="rekening-wrapper" class="space-y-4">
        {{-- Logika untuk menangani input lama (old input) atau form kosong --}}
        @php
            $rekening_list = old('rekening', []);
            if (!is_array($rekening_list) || empty($rekening_list)) {
                $rekening_list = [[]]; // Default satu form kosong
            }
        @endphp
    ...
    reindexForms();
            ...
            <div class="mt-4">
                ...
                <textarea name="keterangan" id="keterangan" rows="3"
                    class="w-full border-gray-300 dark:border-gray-600 rounded-lg shadow-sm text-sm dark:bg-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">{{ old('keterangan') }}</textarea>
            </div>
